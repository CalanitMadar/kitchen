...
//====================================================================
const StorageUnitSufficientStock = ({ route }) => {
    const navigation = useNavigation();
    const [selectedVal, setSelectedVal] = useState();
    const [typeF, setTypeFood] = useState(route.params.typeFood);
        ...
        <View style={styles.container}>
            <View style={styles.line1Style}>
                ...
                <View style={styles.rectangle1Style}>
                    ...
                    <TouchableOpacity
                        onPress={() => { navigation.navigate('EditStorageUnit', {
                             typeFood: typeF , 
                             unit: unit, 
                             emoji: route.params.emoji , 
            ...
            <View style={styles.line2Style}>
                ...
                <View style={styles.rectangle2Style}>
                    ...
                    <Text style={styles.rectangleTextStyle2}> SUFFICIENT STOCK </Text>
                </View>
            ...
            <Button color="#121A29"  title='Add Product' 
                    onPress={() => navigation.navigate('AddProduct',{Inventoryid: route.params.typeFood})}
                ></Button>
            </View>
...
export default StorageUnitSufficientStock;
